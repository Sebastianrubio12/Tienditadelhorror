        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-4">
                    <h5>La licorera con más tradición</h5>

                    <hr>
                    <p>Licores de la mejor calidad, nacionales e importados, aguardiente, ron, whisky, tequila, vodka,
                        vino, ginebra, champaña, cerveza, cogñac, gin tonic, bases para cocteles. 100% garantía. La
                        mejor tienda

                        Solicita tu domicilio y consulta nuestras promociones a través de nuestro sitio web - Vendemos
                        en consignación para fiestas y eventos con la garantía de devolver el dinero de lo que no se
                        consuma - Garantizamos la calidad de nuestros licores - Atendemos domingos y festivos !llámanos¡
                    </p>
    ...
    <footer class="bg-dark">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <hr>
                <p class="text-center">EL EXCESO DE ALCOHOL ES PERJUDICIAL PARA LA SALUD. PROHÍBASE EL EXPENDIO DE
