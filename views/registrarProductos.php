            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="text-dark"><?= $_SESSION["mensaje"] ?></p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="../views/registrarProductos.php"><i class="bi bi-bag-plus "></i>Registrar Productos</a></li>
                                <li><a class="dropdown-item" href="../views/listarProductos.php"><i class="bi bi-bag-check-fill"></i>Lista de productos</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="../views/login.php"><i class="bi bi-person"></i>Inicar
                                        Sesion</a></li>
                            </ul>
                        </li>
                    </ul>
